...
| Add a parse error variant | `enums.py` `ParseErrorKind` → the parser site that detects it → `parser.py` tests | gutter rendering in `giruntime/ui/note_view.py` |
