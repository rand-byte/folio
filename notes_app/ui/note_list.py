...
* The list-display computation is extracted as a free function,
  ...
  :mod:`notes_app.search.note_filter` layer deliberately keeps
...
* CRUD on notes (Open / Duplicate / Delete from the design's
  ...
  alongside :mod:`notes_app.ui.dialogs`.
...
from notes_app.enums import NoteSortKey, SmartFilter
...
The same strings appear in :mod:`notes_app.ui.sidebar`. The two
